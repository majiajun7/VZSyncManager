if __name__ == '__main__':
    ...
    message_content = '\n'.join(vcenter_to_pgsql_sync.logger.handlers[0].logs + zabbix_vcenter_data_sync_external.logger.handlers[0].logs + pgsql_to_zabbix_sync.logger.handlers[0].logs)
